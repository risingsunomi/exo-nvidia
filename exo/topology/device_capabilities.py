...
def get_tinygrad_device() -> (str, str, any):
    import psutil
    ...
    # default gpu_mem
    gpu_mem = psutil.virtual_memory().total // 2**20
    ...
    if Device.DEFAULT == "CUDA" or Device.DEFAULT == "NV" or Device.DEFAULT == "GPU":
        ...
        return (Device.DEFAULT, gpu_name, gpu_mem)
    elif Device.DEFAULT == "AMD":
        return ("AMD", "Unknown AMD", gpu_mem)
    else:
        return (Device.DEFAULT, "Unknown", gpu_mem)
